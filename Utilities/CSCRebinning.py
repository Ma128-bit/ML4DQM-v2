...
def main(df, me_name, ring_id, num_sectors= 180, name="custom_img"):
...
def rebin_image(image, binary_matrix, num_sectors= 180):    
...
def rebin_image_to_vector(image, binary_matrix, num_sectors=180):    
    angles = np.linspace(0, 2 * np.pi, num_sectors, endpoint=False)
    r, c = image.shape
    center = (49.5, 49.5)
